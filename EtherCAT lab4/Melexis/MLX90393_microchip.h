...
#include <hal_io.h>
 ...
 // higher-level API
  ...
  uint8_t begin(struct MLX90393 *hall_sensor, int order_code_last_digit, uint8_t A1, uint8_t A0, bool DRDY, struct i2c_m_sync_desc *const i2c, struct io_descriptor *io); 
